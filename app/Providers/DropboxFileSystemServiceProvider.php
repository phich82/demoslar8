...
class DropboxFileSystemServiceProvider extends ServiceProvider
{
    ...
    {
        // Create new storage driver (dropbox)
        Storage::extend('dropbox', function ($app, $config) {
            // Value of $config variable is as config('filesystem.dropbox)
            ...
            return new Filesystem($this->getCachedAdapter($adapter, $config), ['case_sensitive' => false]);
        });
    }
